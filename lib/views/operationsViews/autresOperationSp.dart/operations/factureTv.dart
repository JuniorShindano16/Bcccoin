...
class factureTvPage extends StatefulWidget {
  @override
  _factureTvPageState createState() => _factureTvPageState();
}

class _factureTvPageState extends State<factureTvPage> {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          icon:
                              Icon(Icons.arrow_drop_down, color: Colors.white),
                          items: ['Canal+', 'EasyTv', 'Bleusat', 'StartTime']
                              .map((service) {
